...
public class GalleryFlipAdapter extends BaseAdapter
{
	...
	public GalleryFlipAdapter(Context context)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		if (convertView == null)
		{
			...
			convertView = new GalleryFlipItem(mContext, galleryPageList.get(position));
		}
		else
		{
			Log.i("GalleryFlipAdapter", "convertView != null");
			((GalleryFlipItem) convertView).refreshView(galleryPageList.get(position));
		}
		return convertView;
	}
